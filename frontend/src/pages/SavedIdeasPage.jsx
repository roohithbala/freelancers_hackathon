  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        >
          <div className="inline-flex items-center space-x-2 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-white/20 dark:border-slate-800 rounded-full px-6 py-3 mb-6 shadow-lg">
            <div className="w-3 h-3 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full animate-pulse"></div>
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Your Project Idea Library</span>
          </div>
        ...
        <Motion.div
          ...
          className="mb-8"
        >
          <Card className="backdrop-blur-xl bg-white/70 dark:bg-slate-900/70 border border-white/20 dark:border-slate-800 shadow-2xl">
            <CardContent>
                ...
                <div className="flex-1">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-gray-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 text-gray-900 dark:text-white"
                    />
                  </div>
                </div>
                ...
                <div className="lg:w-48">
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-gray-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 text-gray-900 dark:text-white appearance-none"
                    >
                      {domains.map((domain) => (
                ...
                <div className="lg:w-48">
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-gray-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 text-gray-900 dark:text-white appearance-none"
                    >
        ...
        {filteredIdeas.length > 0 && (
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-white/20 dark:border-slate-800 rounded-full px-6 py-2 shadow-lg">
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                Showing <span className="font-bold text-indigo-600 dark:text-indigo-400">{filteredIdeas.length}</span> of <span className="font-bold text-purple-600 dark:text-purple-400">{ideas.length}</span> ideas
              </span>
            </div>
          </Motion.div>
        )}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredIdeas.map((idea, index) => (
              <Motion.div
                ...
                className="h-full"
              >
                <Card className="backdrop-blur-xl bg-white/70 dark:bg-slate-900/70 border border-white/20 dark:border-slate-800 shadow-2xl h-full hover:shadow-3xl transition-all duration-300 cursor-pointer group">
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <CardTitle className="text-xl line-clamp-2 mb-3 dark:text-white">
                          {idea.title}
                        </CardTitle>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {(idea.techStack || []).slice(0, 3).map((tech, techIndex) => (
                          <span
                            key={techIndex}
                            className="px-3 py-1 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-700 border border-indigo-200 dark:border-slate-600 rounded-lg text-xs font-mono text-indigo-700 dark:text-indigo-400"
                          >
                            {tech}
                          </span>
                        ))}
                        {(idea.techStack || []).length > 3 && (
                          <span className="px-3 py-1 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-700 border border-indigo-200 dark:border-slate-600 rounded-lg text-xs font-mono text-indigo-700 dark:text-indigo-400">
                            +{(idea.techStack || []).length - 3}
                          </span>
                        )}
                      </div>
